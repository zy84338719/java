...
public class TicTacToeServer extends JFrame {
    ...
    public TicTacToeServer() {
        ...
        try {
            //最多接收2个连接
            server = new ServerSocket(12345, 2); // set up ServerSocketThe maximum queue length for incoming connection indications (a request to connect) is set to the backlog parameter. If a connection indication arrives when the queue is full, the connection is refused.
        } // end try
